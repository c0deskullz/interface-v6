...
import {
  CAVAX, ChainId, Currency,
  CurrencyAmount, FACTORY_ADDRESS, JSBI,
  Token,
  TokenAmount,
  Trade
...
import { PARTY_V1, ROUTER_ADDRESS } from '../../constants';
...
export function useDerivedSwapInfo(): {
  ...
  const currencies: { [field in Field]?: Currency | WrappedTokenInfo } = {
  ...
  if (outputCurrency instanceof WrappedTokenInfo
