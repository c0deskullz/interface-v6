        ...
        {!claimingAllowed ? (
          ...
          <Card padding="40px">
            ...
            <TYPE.body mt="1rem" color={theme.text1} textAlign="center">
              {'You have ' + claimAmount?.toFixed(0, { groupSeparator: ',' }) + ' PARTY available to claim'}
            </TYPE.body>
          </Card>
        ) : attempting ? (
          <EmptyProposals>
          ...
          <ButtonError error={!!error} padding="16px 16px" width="100%" mt="1rem" onClick={onClaim}>
            {error ? error['data']['message'] : 'Claim ' + claimAmount?.toFixed(0, { groupSeparator: ',' }) + ' PARTY'}
          </ButtonError>
        )}
      </TopSection>
    </PageWrapper>
