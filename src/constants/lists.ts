...
export const FUJI_TOKEN_LIST_URL = 'https://raw.githubusercontent.com/PartySwapDEX/token-lists/main/fuji.tokenlist.json'
export const DEFAULT_TOKEN_LIST_URL = 'https://raw.githubusercontent.com/pangolindex/tokenlists/main/ab.tokenlist.json'
