...
export const APEX: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'APE-X', 'APE-X'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, '0xd039C9079ca7F2a87D632A9C0d7cEa0137bAcFB5', 18, 'APE-X', 'APE-X')
}

export const SING: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'SING', 'Sing Token'),
  [ChainId.AVALANCHE]: new Token(
    ChainId.AVALANCHE,
...
export const STAKING_REWARDS_INFO: {
  ...
  [ChainId.AVALANCHE]: [STAKING_V1, STAKING_V2, STAKING_BOOSTED]
}
